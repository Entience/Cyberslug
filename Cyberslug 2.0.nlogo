...
;; Cslug actions
  ...
  ask Cslugs [
    ...
    set Incentive Reward - Reward_neg; put motivation here?
...
Learning happens here according to the Rescorla-Wagner rule for classical learning. What happens if you go into the program and alter the values of the Rescorla-Wagner equation?
